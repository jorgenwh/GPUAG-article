...
When an array of 64-bit integer encoded kmers are provided for either insertion, counting or lookup, each individual kmer is handled by a single CUDA thread.
